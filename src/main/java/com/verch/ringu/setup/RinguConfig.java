...
public class RinguConfig {
  ...
  public static BuffEffect[] buffEffectArrayDefault =
      new BuffEffect[] {
  ...
  public static String[] buffEffectStringArrayDefault =
      BuffEffect.buffEffectArrayToEffectStringArray(buffEffectArrayDefault);
  ...
  public static Effect[] cureEffectArrayDefault =
      new Effect[] {
        Effects.SLOWNESS,
  ...
  public static String[] cureEffectStringArrayDefault =
      EffectUtil.effectArrayToEffectStringArray(cureEffectArrayDefault);
  public static ForgeConfigSpec.ConfigValue<List<? extends String>> cureEffectStringArray;

  private static void flightConfigInit(
      ForgeConfigSpec.Builder commonBuilder, ForgeConfigSpec.Builder clientBuilder) {
    commonBuilder.comment("Flight Settings").push(CATEGORY_FLIGHT);
    clientBuilder.comment("Flight Settings").push(CATEGORY_FLIGHT);

    enableFlight =
        commonBuilder.comment("Whether The One Ring enables flight.").define("enableFlight", true);
  ...
  private static void groundConfigInit(
      ForgeConfigSpec.Builder commonBuilder, ForgeConfigSpec.Builder clientBuilder) {
  ...
  private static void foodConfigInit(
      ForgeConfigSpec.Builder commonBuilder, ForgeConfigSpec.Builder clientBuilder) {
    ...
    foodToAdd =
        commonBuilder.comment("Food to add every second.").defineInRange("foodToAdd", 1, 0, 10);
  ...
  private static void magnetConfigInit(
      ForgeConfigSpec.Builder commonBuilder, ForgeConfigSpec.Builder clientBuilder) {
  ...
  private static void effectConfigInit(
      ForgeConfigSpec.Builder commonBuilder, ForgeConfigSpec.Builder clientBuilder) {
    commonBuilder.comment("Effect Settings").push(CATEGORY_EFFECT);
    clientBuilder.comment("Effect Settings").push(CATEGORY_EFFECT);

    enableEffect =
        commonBuilder.comment("Whether The One Ring gives an effect.").define("enableEffect", true);

    buffEffectStringArray =
        commonBuilder
            .comment(
                "List of Effects to buff with of the form: effect_name,level,duration_in_ticks")
            .defineList(
                "effectList",
                Lists.newArrayList(buffEffectStringArrayDefault),
  ...
  private static void cureConfigInit(
      ForgeConfigSpec.Builder commonBuilder, ForgeConfigSpec.Builder clientBuilder) {
    ...
    cureEffectStringArray =
        commonBuilder
            .comment("List of Effects to cure")
            .defineList(
                "effectList",
                Lists.newArrayList(cureEffectStringArrayDefault),
                s -> s instanceof String);
