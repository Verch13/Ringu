...
public class Ringu {
  ...
  public Ringu() {
    ...
    RinguConfig.loadConfig(
        RinguConfig.CLIENT_CONFIG, FMLPaths.CONFIGDIR.get().resolve("ringu-client.toml"));
    RinguConfig.loadConfig(
        RinguConfig.COMMON_CONFIG, FMLPaths.CONFIGDIR.get().resolve("ringu-common.toml"));
  }
